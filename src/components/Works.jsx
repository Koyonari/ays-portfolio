      ...
      <div className="works-container w-full grid gap-16 place-items-center grid-cols-1 lg:grid-cols-2">
        <div className="works-1 w-full">
          ...
          <div className="flex flex-col sm:flex-row mb-6">
            ...
            <p className="mt-3 text-sm sm:text-xl md:text-2xl lg:text-xl xl:text-2xl border-stone-700 border-[4px] rounded-full p-3 custom-scrollbar me-0 ss:me-auto">
        ...
        <div className="works-2 w-full">
          ...
          <div className="flex flex-col sm:flex-row mb-6">
            ...
            <p className="mt-3 text-sm sm:text-xl md:text-2xl lg:text-xl xl:text-2xl border-stone-700 border-[4px] rounded-full p-3 z-10 custom-scrollbar me-0 ss:me-auto">
