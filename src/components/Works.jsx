...
function Works() {
  return (
    <section className="works lg:m-12" id="works">
      ...
      <div className="works-container w-full md:grid gap-16 place-items-center grid-cols-[repeat(auto-fit,_minmax(600px,_1fr))]">
        <div className="works-1">
          ...
          <p className="flex flex-col sm:flex-row mb-6">
            <p className="mt-3 text-sm sm:text-xl md:text-2xl border-stone-700 border-[4px] rounded-full p-3 mr-4">
              2024
            </p>
            <p className="mt-3 text-sm sm:text-xl md:text-2xl border-stone-700 border-[4px] rounded-full p-3 overflow-x-auto">
        ...
        <div className="works-2">
          ...
          <p className="flex flex-col sm:flex-row mb-6">
            ...
            <p className="mt-3 text-sm sm:text-xl md:text-2xl overflow-x-auto border-stone-700 border-[4px] rounded-full p-3">
        ...
        <div className="works-3 w-full">
          ...
          <p className="flex flex-col sm:flex-row mb-6">
            <p className="mt-3 text-sm sm:text-xl md:text-2xl overflow-x-auto border-stone-700 border-[4px] rounded-full p-3 mr-4">
              2024
            </p>
            <p className="mt-3 text-sm sm:text-xl md:text-2xl overflow-x-auto border-stone-700 border-[4px] rounded-full p-3">
